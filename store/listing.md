# Play Store listing — Pale Blue Dot (en-US)

Copy each section into the matching field in Play Console →
Grow → Store presence → Main store listing. Character limits noted.
...
Explore a live 3D Earth: tap to learn about our planet, space & beyond!
...
• Collect discoveries in your own journal — can you find them all?
...
• No tracking and no personal data collected
• No location needed
• Sharing is behind a parental gate

All the live data comes from free, public NASA and USGS sources. There's nothing to buy and nothing to sign up for — just a whole planet to explore.

Textures and data courtesy of NASA and the USGS.
